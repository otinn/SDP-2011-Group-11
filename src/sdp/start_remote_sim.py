...
if __name__ == "__main__":
    ...
    modules = {
        ...
        'robot': ['python simulator_proxy.py --host ' + options.host + ' -p ' + str(options.port) + ' --multi_host ' + options.multi_host
            + ' --multi_port ' + str(options.multi_port) + (' -e' if options.enemy else ''), None],
    }
